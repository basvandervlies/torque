...
#
# SVN INFO:
#       $Id: init.d 45 2010-10-11 11:55:18Z bas $
#		$URL: https://oss.trac.surfsara.nl/torque_2_deb/svn/branches/2.4/init.d $
#
### BEGIN INIT INFO
# Provides:          torque
...
case "$1" in
        ...
        *)
                echo "Usage: $0 {restart|start|stop|restart-mom|restart-server|restart-sched}\n" >&2
                exit 1
        ;;
esac
